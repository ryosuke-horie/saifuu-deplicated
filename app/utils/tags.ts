 ...
 */
export function stringifyTransactionTags(
 ...
 * APIレスポンス処理で使用
 */
export function parseTransactionWithTags<
	T extends { id: number; tags: string | null },
>(transaction: T): Omit<T, "tags"> & { tags: string[] | null } {
	return {
		...transaction,
 ...
 * APIレスポンス処理で使用
 */
export function parseTransactionsWithTags<
	T extends { id: number; tags: string | null },
>(transactions: T[]): Array<Omit<T, "tags"> & { tags: string[] | null }> {
